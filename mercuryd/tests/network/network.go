...
import (
	...
	evmtestutil "github.com/huyCuong73/mercury/testutil"
...
func DefaultConfig() Config {
	...
	tempApp := mercuryd.NewExampleApp(log.NewNopLogger(), dbm.NewMemDB(), nil, true, simutils.NewAppOptionsWithFlagHome(dir), baseapp.SetChainID(chainID))
...
func New(l Logger, baseDir string, cfg Config) (*Network, error) {
	...
	for i := 0; i < cfg.NumValidators; i++ {
		...
		nodeDir := filepath.Join(network.BaseDir, nodeDirName, "mercuryd")
