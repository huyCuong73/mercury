...
import (
	...
	clientkeys "github.com/huyCuong73/mercury/client/keys"
	...
	"github.com/huyCuong73/mercury/mercuryd/tests/ledger/mocks"
...
func (suite *LedgerTestSuite) SetupEvmosApp() {
	...
	suite.app = mercuryd.Setup(suite.T(), chainID.ChainID, chainID.EVMChainID)
